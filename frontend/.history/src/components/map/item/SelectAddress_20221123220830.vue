<template>
  <v-toolbar>
    ...
    <v-select
      ...
      label="동 선택"
    ></v-select>
    <v-chip class="ma-2" close color="#036635" text-color="white" v-if="search.starbucks">
      <v-avatar left>
        <v-icon>mdi-coffee-outline</v-icon>
      </v-avatar>
      스타벅스
    </v-chip>
    <v-chip class="ma-2" close color="red" text-color="white" v-if="search.shcool">
      <v-avatar left>
        <v-icon>mdi-home-outline</v-icon>
      </v-avatar>
      학교
    </v-chip>
    <v-chip class="ma-2" close color="green" text-color="white" v-if="search.cafe">
      <v-avatar left>
        <v-icon>mdi-coffee</v-icon>
      </v-avatar>
      카페
    </v-chip>
    <v-chip class="ma-2" close color="blue" text-color="white" v-if="search.store">
      <v-avatar left>
  ...
  <v-chip class="ma-2" 
    v-for="tag, i in search.etc" color="blue" text-color="white" 
    :key="i"
    close
  >
    {{ tag }}
